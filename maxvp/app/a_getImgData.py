def getImgData(x,y,phoneColor,clickType,busNo):
	...
	with io.open('/home/pboord/Downloads/yelp/yelp_secret.json') as cred:
		...
		client = Client(auth)	
	pathList = ['/home/pboord/Downloads/yelp/img/yelpHongKong4.jpg', '/home/pboord/Downloads/yelp/img/hongKong.jpg']
	path_to_image_to_be_processed = pathList[busNo]
	if clickType == 'screenClick':
		...
		cv2.imwrite('/home/pboord/Downloads/yelp/warped_boxed.jpg',vis)		
		imgData = open('/home/pboord/Downloads/yelp/warped_boxed.jpg', 'rb').read().encode('base64').replace('\n', '')
		imSeg = img[ rect[1]:rect[1]+rect[3], rect[0]:rect[0]+rect[2] ]
		cv2.imwrite('/home/pboord/Downloads/yelp/boxText.jpg',imSeg)
		...
		text_file = open("/home/pboord/Downloads/yelp/boxText.txt", "w")
		text_file.write("%s" % boxText)
		text_file.close()	
